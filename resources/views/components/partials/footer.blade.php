<div class="bg-slate-800 text-slate-100 p-4">
    <br><br>
    <div class="w-4/5 flex md:flex-row flex-col mx-auto p-4">
        <div class="w-full md:w-1/4 p-3">
            <div class="font-bold mb-4 text-lg">About Us</div>
            <div class="text-justify font-thin">Lorem ipsum dolor sit amet consectetur adipisicing elit. Odio, natus officia, quo corrupti eius similique, dicta molestiae suscipit ratione nisi sit libero ipsam culpa impedit? Eum maxime non qui minima.</div>
        </div>
        <div class="md:w-1/4 p-3">
            <div class="font-bold mb-4 text-lg">Navigations</div>
        ...
        <div class="w-full md:w-1/4 p-3">
            <div class="font-bold mb-4 text-lg">Follow Us</div>
            <div class="flex flex-wrap gap-2">
                <a href="" class="h-8 ">
                    <svg fill="#ffffff" height="20px" width="20px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="-337 273 123.5 256" xml:space="preserve" stroke="#ffffff">
                ...
                <a href="" class="h-8 ">
                    <svg fill="#ffffff" height="20px" width="20px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="-271 296.6 256.4 208.4" xml:space="preserve" stroke="#ffffff">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
                ...
                <a href="" class="h-8 ">
                    <svg viewBox="0 0 24 24" height="20px" width="20px" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#ffffff">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
                ...
                <a href="" class="h-8 ">
                    <svg viewBox="0 0 24 24" height="20px" width="20px" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#000000">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
        ...
        <div class="w-full md:w-1/4 p-3">
            <div class="font-bold mb-4 text-lg">Contact Us</div>
            <div class="text-justify font-thin">Lorem ipsum dolor sit amet consectetur adipisicing elit. Odio, natus officia, quo corrupti eius similique, dicta molestiae suscipit ratione nisi sit libero ipsam culpa impedit? Eum maxime non qui minima.</div>

        </div>
    </div>
    <div>
        <div class="text-slate-500 border-t border-slate-500 h-24 w-4/5 mx-auto flex items-center justify-center">
        Copyright © Anant Code @php echo date('Y'); @endphp All rights reserved
        </div>
    </div>
</div>    